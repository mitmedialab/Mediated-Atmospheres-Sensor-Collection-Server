...
The *Sensor Cellection Server* is the Mediated Atmospheres 2.0 sensor system building on the the [https://twistedmatrix.com/trac/](Twisted) event-based framework. It handles the connection, the incoming datastream, and the storage of the data of vairous sensors including Zyphir Bioharness 3 (requires [https://github.com/jpaalasm/zephyr-bt/tree/master/src/zephyr](zephyr-bt library)), Empatica E4, and Intraface Facial Feature Tracking Software.
